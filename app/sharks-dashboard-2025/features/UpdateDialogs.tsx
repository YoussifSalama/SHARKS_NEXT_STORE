...
import { updateOneSubCategory } from "@/app/actions/category/subcategory";
import DynamicSubCategoryCard from "./DynamicSubCategoryCard";
...
export const UpdateSubCategoryDialog = ({
    ...
    const handleUpdate = async (formData: CategoryCardData) => {
        ...
        try {
            ...
            const result = await updateOneSubCategory(formData.id as number, {
                ...formData,
                img: imageUrl as string,
            });
