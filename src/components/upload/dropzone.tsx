...
const DROPZONE_VARIANTS = {
  base: 'relative rounded-md p-4 w-full flex justify-center items-center flex-col cursor-pointer border shadow-md transition-colors duration-200 ease-in-out',
  active: 'border-rind',
  disabled:
    'bg-muted border-muted-foreground cursor-default pointer-events-none opacity-50',
  accept: 'border-ring bg-primary/10',
    ...
    return (
      <div className="w-full">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center gap-2 text-center text-black">
